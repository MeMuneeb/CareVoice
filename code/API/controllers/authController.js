...
exports.protect = catchAsync(async (req, res, next) => {
  // Getting token from cookies and check if it's there
...
exports.checkDoctorRole = catchAsync(async (req, res, next) => {
...
exports.checkPatientRole = catchAsync(async (req, res, next) => {
